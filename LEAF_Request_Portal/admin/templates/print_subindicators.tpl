            ...
            <!--{/if}-->
                <span class="printsubheading" style="cursor: pointer" title="indicatorID: <!--{$indicator.indicatorID}-->">
                    ...
                    <!--{if $indicator.format|in_array:['text','dropdown','multiselect','radio', 'checkboxes', '', 'fileupload', 'image', 'textarea', 'orgchart_employee', 'orgchart_group', 'orgchart_position']}-->
                        &nbsp;<img id="edit_conditions_<!--{$indicator.indicatorID}-->" src="../dynicons/?img=preferences-system.svg&amp;w=16" tabindex="0" onkeypress="updateVueData(<!--{$indicator.indicatorID}-->)" onclick="updateVueData(<!--{$indicator.indicatorID}-->);" alt="Edit Conditions" title="Edit conditions" style="cursor: pointer" />
                    <!--{/if}-->
                    <!--{if $indicator.has_code}-->
                        &nbsp;<img src="../dynicons/?img=document-properties.svg&amp;w=16" tabindex="0" alt="Advanced Options present" title="Advanced Options present" style="cursor: pointer" />
                    <!--{/if}-->
